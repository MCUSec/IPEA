...
unsigned char DeviceTestCaseBuffer[200 + sizeof(unsigned int) * 2] __attribute__ ((section (".noinit")));
#endif
                                              ...
                                              usb_host_transfer_t **ptransfer)
{
    ...
    switch (trState)
    {
        ...
        case kKhci_TrTransmitDone:
            ...
            {
#if ENABLE_FUZZ
                if(transfer->transferSofar){
                    if(TestCaseIdx + transfer->transferSofar <= TestCaseLen){
                        memcpy(transfer->transferBuffer, DeviceTestCaseBuffer + TestCaseIdx, transfer->transferSofar);
                        TestCaseIdx += transfer->transferSofar;
                    }
                }
#endif
