...
static const u8* trampoline_fmt_32 = "\tpush\t{r0}\n\tmov\tr0, #%ld\n\tbl\tSEGGER_RTT_Write_Random\n\tpop\t{r0}\n";
static const u8* it_trampoline_fmt_32 = "\tpush\t{r0}\n\tite\t%c%c\n\tmov%c%c\tr0, #%ld\n\tmov%c%c\tr0, #%ld\n\tbl\tSEGGER_RTT_Write_Random\n\tpop\t{r0}\n";
static const u8* main_asan_init_fmt_32 = "\tbl\tMcuASAN_Init\n";
//   "\n"
