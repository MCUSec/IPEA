...
__attribute__ ((weak, no_instrument_function)) void SystemInitHook (void) {
  /* Void implementation of the weak function. */
}


__attribute__ ((naked, no_instrument_function)) void HardFault_Handler(void)
{
  __asm volatile(
    "bkpt #0x50  \n"
    "b    .      \n"
...
__attribute__ ((naked, no_instrument_function)) void _exit(int exitcode)
{
  __asm volatile(
    "bkpt #0x20 \n"
    "b    .     \n"
